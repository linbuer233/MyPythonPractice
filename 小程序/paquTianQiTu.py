...
levels = [
        # '/html/body/div[2]/div/div[2]/div[1]/div[1]/div[2]/ul/li[1]/a',
...
area = [
        # '/html/body/div[2]/div/div[2]/div[1]/div[1]/div[1]/ul/li[1]/a',
...
#     print('ps:尽量不要选择 C 盘下的路径，除非确保有权限在 C 盘写入文件。')
#     while True:
#         inputpath = input()
...
for area_i in area:
    ...
    for levels_i in levels:
        ...
        list = driver.find_elements(by=By.XPATH, value='//*[@id="mCSB_1_container"]/div')  ##存放天气图各个时刻一起的 Xpath 路径
        for path in list:  ##依次读取下载存放天气图
            ...
            img_name_hour = str(int(img_name[8:12]) + 10800)  ###转换成北京时间，并且为了小时分钟显示 0000 这样的格式，加了 10800，后面再截取
